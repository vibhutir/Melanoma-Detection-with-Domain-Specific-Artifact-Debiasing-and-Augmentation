...
def parse_args():
    ...
    parser.add_argument('--batch-size', help='sets batch size', type=int, default=32)
    parser.add_argument('--num-workers', help='sets number of cpu workers', type=int, default=4)
    ...
    # Custom Flags
    parser.add_argument('--META', help='Uses Meta Data for training', action='store_true')
    parser.add_argument('--domainAug', help='Perform Domain Specific Augmentation', action='store_true')
